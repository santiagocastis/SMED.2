				...
				<ul class="nav navbar-right top-nav pull-right">
					...
					<li class="dropdown auth-drp">
						...
						<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
							...
							<li>
								<a href="index.php"><i class="zmdi zmdi-card"></i><span>Mi balance</span></a>
							</li>
							<li>
								<a href="reset-password.php"><i class="zmdi zmdi-settings"></i><span>Configuraciones</span></a>
							</li>
							<li class="divider"></li>
							<li class="divider"></li>
							<li>
								<a href="cerrarSesion.php ?>"><i class="zmdi zmdi-power"></i><span>Salir</span></a>
							</li>
						</ul>
					</li>
				</ul>
